...
/*   Updated: 2021/03/19 10:51:21 by ctaleb           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	sprite_init(t_mlx_params *mlx)
{
	...
	mem_check(mlx->sp, mlx, 2);
	sprite_finder(mlx);
	mlx->sp_txt = malloc(sizeof(t_texture));
	mem_check(mlx->sp_txt, mlx, 2);
	...
	mem_check(mlx->sp_txt->ptr, mlx, 13);
}
